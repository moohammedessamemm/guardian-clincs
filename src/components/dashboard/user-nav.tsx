...
export function UserNav() {
    return (
        <div className="flex items-center gap-2">
            <Button variant="ghost" size="icon" className="text-slate-500 hover:text-[#004b87] hover:bg-blue-50" asChild>
                <Link href="/settings">
            ...
            <form action="/auth/signout" method="post">
                <Button variant="ghost" size="icon" className="text-slate-500 hover:text-red-600 hover:bg-red-50" title="Sign Out">
